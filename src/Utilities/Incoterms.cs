...
namespace LogisticsUtilities
{
    ...
    public record Incoterm(int Id, string Name, string Description, Dictionary<ChargeCategory, Party> ChargeResponsibilities);

    public static class Incoterms
    {
        public static readonly Incoterm EXW = new(1, "EXW", "Ex-Works", new Dictionary<ChargeCategory, Party>
        {
        ...
        public static readonly Incoterm FCA = new(2, "FCA", "Free-Carrier",new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
        ...
        public static readonly Incoterm FAS = new(3, "FAS", "Free Along-Side Ship", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm FOB = new(4, "FOB", "Free On Board",new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm CFR = new(5, "CFR", "Cost and Freight", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm CIF = new(6, "CIF", "Cost Insurance and Freight", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm CPT = new(7, "CPT", "Carriage Paid To",new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm CIP = new(8, "CIP", "Carriage Insurance Paid To", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm DAP = new(14, "DAP", "Delivered at Place",new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm DPU = new(12, "DPU", "Delivered at Place Unloaded",new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm DDP = new(13, "DDP", "Delivery Duty Paid", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
        ...
        public static readonly Incoterm DAT = new(15, "DAT", "Delivered at Terminal", new Dictionary<ChargeCategory, Party>
        {
            { ChargeCategory.ExportPackaging, Party.Supplier },
            { ChargeCategory.MarkingAndLabelling, Party.Supplier },
            { ChargeCategory.LoadingCharges, Party.Supplier },
